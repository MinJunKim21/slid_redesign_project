...
function Pricing() {
  ...
  return (
    <div className="px-4 pt-2">
      ...
      <div className=" px-4 pt-2 mb-20 mx-auto">
        <div className="pt-10">
          ...
          <h5 className="text-[14px] font-light text-center mx-auto mt-4 mb-10">
            나에게 맞는 회원권을 선택해주세요.
          </h5>
        </div>

        <div className="bg-gray-200 rounded-md p-1 mt-4 max-w-xl mx-auto">
        ...
        <div className="max-w-xl md:max-w-6xl md:flex md:space-x-4 lg:space-x-8 mx-auto justify-center">
          <div className="border-2 rounded-xl mt-8 py-8 px-6 flex flex-col justify-between ">
            <div>
          ...
          {!isMoved ? (
            <div className="border-[3px] rounded-xl mt-8 py-8 px-6 border-[#2e90ff] flex flex-col justify-between">
              <div>
                ...
                <h5 className="text-gray-400 pt-1">
                  총 결제액 <span className="line-through">96,000</span>{' '}
                  80,000원
                </h5>
